...
public class Addenda17 {
  ...
  public Addenda17 id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Addenda17 typeCode(@javax.annotation.Nonnull String typeCode) {
  ...
  public Addenda17 paymentRelatedInformation(@javax.annotation.Nonnull String paymentRelatedInformation) {
  ...
  public Addenda17 sequenceNumber(@javax.annotation.Nonnull Integer sequenceNumber) {
  ...
  public Addenda17 entryDetailSequenceNumber(@javax.annotation.Nonnull Integer entryDetailSequenceNumber) {
  ...
  public Addenda17 lineNumber(@javax.annotation.Nullable Integer lineNumber) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, addenda17.id) &&
        ...
        Objects.equals(this.lineNumber, addenda17.lineNumber);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Addenda17
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Addenda17.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Addenda17 is not found in the empty JSON string", Addenda17.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Addenda17.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Addenda17` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Addenda17.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Addenda17.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Addenda17' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Addenda17> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Addenda17.class));

       return (TypeAdapter<T>) new TypeAdapter<Addenda17>() {
           @Override
           public void write(JsonWriter out, Addenda17 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Addenda17 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Addenda17 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Addenda17
   * @throws IOException if the JSON string is invalid with respect to Addenda17
   */
  public static Addenda17 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Addenda17.class);
  }

  /**
   * Convert an instance of Addenda17 to an JSON string
   *
   * @return JSON string
   */
