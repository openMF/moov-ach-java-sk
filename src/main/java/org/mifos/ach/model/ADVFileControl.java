...
public class ADVFileControl {
  ...
  public ADVFileControl id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ADVFileControl batchCount(@javax.annotation.Nonnull Integer batchCount) {
  ...
  public ADVFileControl blockCount(@javax.annotation.Nonnull Integer blockCount) {
  ...
  public ADVFileControl entryAddendaCount(@javax.annotation.Nonnull Integer entryAddendaCount) {
  ...
  public ADVFileControl entryHash(@javax.annotation.Nonnull Long entryHash) {
  ...
  public ADVFileControl totalDebit(@javax.annotation.Nonnull Long totalDebit) {
  ...
  public ADVFileControl totalCredit(@javax.annotation.Nonnull Long totalCredit) {
  ...
  public ADVFileControl lineNumber(@javax.annotation.Nullable Integer lineNumber) {
  ...
  public boolean equals(Object o) {
    ...
    ADVFileControl adVFileControl = (ADVFileControl) o;
    return Objects.equals(this.id, adVFileControl.id) &&
        Objects.equals(this.batchCount, adVFileControl.batchCount) &&
        Objects.equals(this.blockCount, adVFileControl.blockCount) &&
        Objects.equals(this.entryAddendaCount, adVFileControl.entryAddendaCount) &&
        Objects.equals(this.entryHash, adVFileControl.entryHash) &&
        Objects.equals(this.totalDebit, adVFileControl.totalDebit) &&
        Objects.equals(this.totalCredit, adVFileControl.totalCredit) &&
        Objects.equals(this.lineNumber, adVFileControl.lineNumber);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ADVFileControl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ADVFileControl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ADVFileControl is not found in the empty JSON string", ADVFileControl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ADVFileControl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ADVFileControl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ADVFileControl.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ADVFileControl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ADVFileControl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ADVFileControl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ADVFileControl.class));

       return (TypeAdapter<T>) new TypeAdapter<ADVFileControl>() {
           @Override
           public void write(JsonWriter out, ADVFileControl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ADVFileControl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ADVFileControl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ADVFileControl
   * @throws IOException if the JSON string is invalid with respect to ADVFileControl
   */
  public static ADVFileControl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ADVFileControl.class);
  }

  /**
   * Convert an instance of ADVFileControl to an JSON string
   *
   * @return JSON string
   */
